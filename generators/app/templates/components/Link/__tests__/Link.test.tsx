...
describe('Link component', () => {
  ...
  it('Is internal link rendered properly', () => {
    const wrapper = mount(<Link type='internal' url='email@domain.com' title='title' />)
  ...
  it('Is mailto link rendered properly', () => {
    const wrapper = mount(<Link type='mailto' url='email@domain.com' title='title' />)
  ...
  it('Is external link rendered properly', () => {
    const wrapper = mount(<Link type='external' url='http://domain.com' title='External link' />)
